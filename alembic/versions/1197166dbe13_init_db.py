...
Revision ID: 1197166dbe13
Revises: 
Create Date: 2024-07-15 12:59:45.035097
...
def upgrade() -> None:
    ...
    sa.Column('peso', sa.Float(precision=50), nullable=False),
    sa.Column('altura', sa.Float(precision=50), nullable=False),
